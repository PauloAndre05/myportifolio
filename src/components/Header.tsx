...
export function Header () {
    ...
    return(
        <header>
            <section className="flex justify-between items-center px-[5rem] py-[.8rem] bg-secound fixed right-0 left-0 z-50 max-sm:px-3 max-sm:py-4 max-sm:bg-transparent max-sm:absolute  shadow-lg">
                <a href='#' className="flex items-center gap-2">
                    <div className='w-10 rounded-[100%] overflow-hidden max-sm:w-8'>
                        <img
                    ...
                    <h1 className="font-bold text-[1.3rem]  border-b-4 border-third max-sm:text-[1.5rem]  tracking-wider max-sm:border-none">Paulo</h1>
                </a>
                ...
                <div className="flex flex-col justify-center items-center max-sm:hidden">
                    ...
                    <div className="flex justify-center items-center flex-col">
                        <h1 className="font-bold text-[1.2rem]">Software Developer</h1>
                    </div>
            
                    <div className="flex gap-3 ">
                            <a href="#" className="px-5 flex justify-center items-center text-[.9rem] bg-third rounded-full hover:opacity-80">
                                LinkedIn
                            </a>
                            <a href="https://github.com/pauloandre05" target='_blank' className="px-5 flex justify-center items-center text-[.9rem] bg-primary rounded-full hover:bg-white hover:text-black">
                                GitHub
                            </a>
                    </div>
                </div>
